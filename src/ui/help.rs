...
pub fn render_help(frame: &mut Frame) {
    ...
    let help_text = vec![
        ...
        Line::from(""),
        Line::from(vec![
            Span::styled("  Connection", Style::default().fg(Color::Cyan).bold()),
        ]),
        Line::from("  c              Connect / Switch connection"),
        Line::from("  r / F5         Refresh entities"),
        Line::from(""),
        Line::from(vec![
            Span::styled("  Entity Operations", Style::default().fg(Color::Cyan).bold()),
        ]),
        Line::from("  n              Create new entity"),
        Line::from("  x              Delete selected entity"),
        Line::from(""),
        Line::from(vec![
            Span::styled("  Message Operations", Style::default().fg(Color::Cyan).bold()),
        ]),
        ...
        Line::from(Span::styled("                 (on topics: operates across all subs)", Style::default().fg(Color::DarkGray))),
        Line::from("  1/2            Switch Messages/DLQ tab"),
        Line::from("  Enter          View message detail"),
        Line::from("  Esc            Close message detail"),
        Line::from(""),
        Line::from(vec![
            Span::styled("  Bulk Operations (Messages panel)", Style::default().fg(Color::Cyan).bold()),
        ]),
        Line::from("  R (shift)      Resend DLQ → main entity"),
        Line::from("  D (shift)      Bulk delete messages"),
        Line::from(Span::styled("                 (on topics: fan-out across all subs)", Style::default().fg(Color::DarkGray))),
        Line::from("  e              Edit & resend (inline WYSIWYG)"),
        Line::from(""),
        Line::from(vec![
            Span::styled("  Editing (inline & forms)", Style::default().fg(Color::Cyan).bold()),
        ]),
